...
export default function WhatsAppButton() {
  ...
  return (
    <motion.a
      ...
      className="fixed top-6 right-6 z-50 w-14 h-14 bg-[#25D366] text-white rounded-full shadow-lg flex items-center justify-center hover:bg-[#20BA5A] transition-colors"
