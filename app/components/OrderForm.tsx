  ...
  return (
    ...
    >
      <div className="space-y-4 sm:space-y-6">
        <div>
          <label htmlFor="name" className="block text-sm font-semibold mb-2">Nom complet * الإسم الكامل</label>
        ...
        <div>
          <label htmlFor="phone" className="block text-sm font-semibold mb-2">Numéro de téléphone * رقم الهاتف</label>
          <input type="tel" id="phone" name="phone" required pattern="^0[5-7][0-9]{8}$"
        ...
        <div>
          <label htmlFor="wilaya" className="block text-sm font-semibold mb-2">Wilaya * الولاية</label>
          <select id="wilaya" name="wilaya" required value={form.wilaya} onChange={handleChange}
            className="w-full px-4 py-3 bg-white border border-tan/30 rounded-xl focus:outline-none focus:ring-2 focus:ring-tan transition-all">
        ...
        <div>
          <label htmlFor="baladiya" className="block text-sm font-semibold mb-2">Adresse complète * العنوان الكامل</label>
          <textarea id="baladiya" name="baladiya" required value={form.baladiya} onChange={handleChange} rows={3}
        ...
        <div>
          <label htmlFor="pointure" className="block text-sm font-semibold mb-2">Pointure * المقاس</label>
          <select id="pointure" name="pointure" required value={form.pointure} onChange={handleChange}
            className="w-full px-4 py-3 bg-white border border-tan/30 rounded-xl focus:outline-none focus:ring-2 focus:ring-tan transition-all">
        ...
        <div className="pt-4">
          ...
          <p className="text-xs text-gray-600 text-center mt-3">سعر التوصيل 500 دج لكامل الولايات</p>
        </div>
      </div>
    </motion.form>
  );
